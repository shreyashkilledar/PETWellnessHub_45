  ...
  render() {
    return (
      <>
        ...
        <div className="d-flex flex-wrap  justify-content-center align-items-center mt-4">
        <div className="card  w-27 col-5 mx-5 border-5">
          ...
          <div className="card  w-27 col-5 mx-5 border-5">
            <div className="row g-0">
              <div className="col-md-4">
                <img src="https://img.freepik.com/premium-photo/woman-dog-training-paw-studio-learning-focus-greeting-with-dog-food-by-white-background-trainer-pet-animal-listen-teaching-reward-care-while-isolated-bonding_590464-126552.jpg"
                  style={{ width: "300px", height: "200px" }}
                  alt="Card image cap" />
              </div>
              <div className="col-md-8">
                <div className="card-body ">
                  ...
                  <p className="card-text">Professional Trainer for your pet </p>
                  <a href="http://localhost:3000/vet" className="btn btn-primary ">Book an Appointment</a>
                </div>
              </div>
            </div>
